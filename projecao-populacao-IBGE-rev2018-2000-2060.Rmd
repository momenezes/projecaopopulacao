...
projecao_mulheres <- read_csv("~/datasets/IBGE/ProjecaoPopulacao/projecao-rev2018-mulheres-populacao-2000-2060.csv")
projecao_homens <- read_csv("~/datasets/IBGE/ProjecaoPopulacao/projecao-rev2018-homens-populacao-2000-2060.csv")
...
ggplot(data = filter(popBR, Ano == "2010"), aes(x = as_factor(FxEtaria), y = Populacao, fill = Sexo, group = Populacao)) +
  ...
  geom_text( aes(label = scales::percent(round(PopulacaoProp,3), acuracy = 0.1), y = Populacao + 500000*sign(Populacao) , group = Populacao),  color="black", size=2.5) +
